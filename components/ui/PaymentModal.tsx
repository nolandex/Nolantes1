...
const PaymentModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      ...
      {/* Main Payment Modal */}
      <div className="w-full max-w-sm overflow-y-auto rounded-xl bg-white shadow-xl">
          ...
          <div className="space-y-2 mb-4">
            ...
            <div>
              <button
                ...
                className="w-full bg-white rounded-lg p-2 flex items-center cursor-pointer shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-200"
              >
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-3">
                    {[
                      ...
                      <button
                        ...
                        className={`p-2 rounded-lg cursor-pointer hover:bg-gray-100 transition-all duration-200 ${selectedBank === bank.id.toUpperCase() ? 'bg-blue-100' : ''}`}
                      >
                      ...
                      <div className="bg-gray-50 p-3 rounded-lg mb-3">
                        <div className="mb-2">
                          ...
                          <div className="flex items-center">
                            <span className="font-mono bg-gray-100 p-1 rounded flex-1 text-sm">{vaNumber}</span>
                            <button
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-3">
                    {[
                      ...
                      <button
                        ...
                        className={`p-2 rounded-lg cursor-pointer hover:bg-gray-100 transition-all duration-200 ${selectedWallet === wallet.id.toUpperCase() ? 'bg-blue-100' : ''}`}
                      >
                        <div className="relative w-full h-8">
                          <Image
                            src={wallet.logo}
                    ...
                    <>
                      <div className="bg-gray-50 p-3 rounded-lg mb-3">
                        <div className="mb-2">
                          ...
                          <div className="flex items-center">
                            <span className="font-mono bg-gray-100 p-1 rounded flex-1 text-sm">{paymentCode}</span>
                            <button
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3">
                    {[
                      ...
                      <button
                        ...
                        className={`p-2 rounded-lg cursor-pointer hover:bg-gray-100 transition-all duration-200 ${selectedRetail === retail.id.toUpperCase() ? 'bg-blue-100' : ''}`}
                      >
                        <div className="relative w-full h-8">
                          <Image
                            src={retail.logo}
