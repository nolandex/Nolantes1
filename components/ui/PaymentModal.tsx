    ...
    <>
      <style jsx>{`
        ...
        .payment-modal .header-subtitle {
          color: #ffffff !important; /* white untuk judul */
        }
        ...
        .payment-method-container .payment-method {
          padding: 0.5rem !important; /* Kurangi padding */
          font-size: 0.875rem !important; /* Kurangi ukuran font */
        }
        .payment-method-container .method-item {
          padding: 0.25rem !important; /* Kurangi padding untuk item bank/ewallet/retail */
        }
      `}</style>
        ...
        <div className="payment-modal w-full max-w-md overflow-y-auto rounded-xl bg-white shadow-xl max-h-[90vh]">
          <div className="bg-blue-600 p-6 rounded-t-xl">
            <div className="flex justify-between items-center">
              <div>
                <h2 className="header-title text-xl font-bold">{plan.name}</h2>
                <p className="header-subtitle text-sm mt-1">{plan.product}</p>
              </div>
            ...
            <div className="space-y-2 mb-6">
              ...
              <div className="payment-method-container">
                <button
                  ...
                  className="payment-method w-full bg-white rounded-lg flex items-center cursor-pointer shadow-sm hover:-translate-y-1 hover:shadow-md transition-all duration-200"
                >
              ...
              <div className="payment-method-container">
                ...
                {activeMethod === 'va' && (
                  <div className={`payment-details max-h-0 overflow-hidden transition-all duration-300 ease-out ${activeMethod === 'va' ? 'max-h-[500px]' : ''}`}>
                    <div className="payment-details-content p-3">
                      rambling: 0.25rem !important; /* Kurangi padding untuk item bank/ewallet/retail */
        }
      `}</style>
                  ...
                  <div className={`payment-details max-h-0 overflow-hidden transition-all duration-300 ease-out ${activeMethod === 'va' ? 'max-h-[500px]' : ''}`}>
                    <div className="payment-details-content p-3">
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-4">
                        {[
                          { name: 'BCA', logo: '/images/logo2.png' },
                          { name: 'Mandiri', logo: '/images/logo3.png' },
                          { name: 'BNI', logo: '/images/logo4.png' },
                        ].map((bank) => (
                          <button
                            key={bank.name}
                            onClick={() => {
                            ...
                            className={`method-item rounded-lg cursor-pointer text-center hover:bg-gray-100 transition-all duration-200 ${selectedBank === bank.name ? 'bg-blue-100' : ''}`}
                          >
                            <Image
                              src={bank.logo}
                              alt={bank.name}
                ...
                {activeMethod === 'ewallet' && (
                  <div className={`payment-details max-h-0 overflow-hidden transition-all duration-300 ease-out ${activeMethod === 'ewallet' ? 'max-h-[500px]' : ''}`}>
                    <div className="payment-details-content p-3">
                      ...
                      <div className="grid grid-cols-3 gap-2 mb-4">
                        {[
                          { name: 'DANA', logo: '/images/logo5.png' },
                          { name: 'GoPay', logo: '/images/logo6.png' },
                          { name: 'OVO', logo: '/images/logo7.png' },
                        ].map((wallet) => (
                          <button
                            key={wallet.name}
                            onClick={() => {
                            ...
                            className={`method-item rounded-lg cursor-pointer text-center hover:bg-gray-100 transition-all duration-200 ${selectedWallet === wallet.name ? 'bg-blue-100' : ''}`}
                          >
                            <Image
                              src={wallet.logo}
                              alt={wallet.name}
                  ...
                  <div className={`payment-details max-h-0 overflow-hidden transition-all duration-300 ease-out ${activeMethod === 'retail' ? 'max-h-[500px]' : ''}`}>
                    <div className="payment-details-content p-3">
                      ...
                      <div className="grid grid-cols-2 gap-2 mb-4">
                        {[
                          { name: 'Alfamart', logo: '/images/logo8.png' },
                          { name: 'Indomaret', logo: '/images/logo9.png' },
                        ].map((retail) => (
                          <button
                            key={retail.name}
                            onClick={() => {
                            ...
                            className={`method-item rounded-lg cursor-pointer text-center hover:bg-gray-100 transition-all duration-200 ${selectedRetail === retail.name ? 'bg-blue-100' : ''}`}
                          >
                            <Image
                              src={retail.logo}
                              alt={retail.name}
