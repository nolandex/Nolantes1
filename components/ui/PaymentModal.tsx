                      ...
                      {[
                        ...
                        <button
                          ...
                          className={`method-item p-2 rounded-lg cursor-pointer hover:bg-gray-100 transition-all duration-200 ${
                            selectedBank === bank.id.toUpperCase() ? "bg-blue-100" : ""
                          }`}
                        >
                    ...
                    {selectedBank && (
                      <>
                        ...
                        <div className="bg-yellow-50 p-2 rounded-lg text-xs text-yellow-800 mb-3">
                          <p>
                            <FontAwesomeIcon icon={faExclamationCircle} className="mr-1" /> Transfer tepat sesuai nominal
                  ...
                  <div className="payment-details-content p-3">
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-3">
                      {[
                        ...
                        <button
                          ...
                          className={`method-item p-2 rounded-lg cursor-pointer hover:bg-gray-100 transition-all duration-200 ${
                            selectedWallet === wallet.id.toUpperCase() ? "bg-blue-100" : ""
                          }`}
                        >
                          <div className="relative w-full h-8">
                            <Image
                    ...
                    {selectedWallet && (
                      <>
                        ...
                        <div className="bg-blue-50 p-2 rounded-lg text-xs text-blue-800 mb-3">
                          <p>
                            <FontAwesomeIcon icon={faInfoCircle} className="mr-1" /> Anda akan diarahkan ke aplikasi untuk
                  ...
                  <div className="payment-details-content p-3">
                    ...
                    <div className="grid grid-cols-2 gap-2 mb-3">
                      {[
                        ...
                        <button
                          ...
                          className={`method-item p-2 rounded-lg cursor-pointer hover:bg-gray-100 transition-all duration-200 ${
                            selectedRetail === retail.id.toUpperCase() ? "bg-blue-100" : ""
                          }`}
                        >
                          <div className="relative w-full h-8">
                            <Image
                    ...
                    {selectedRetail && (
                      <>
                        ...
                        <div className="bg-yellow-50 p-2 rounded-lg text-xs text-yellow-800 mb-3">
                          <p>
                            <FontAwesomeIcon icon={faExclamationCircle} className="mr-1" /> Kode pembayaran akan kadaluarsa
                            dalam 24 jam
                          </p>
                        </div>
