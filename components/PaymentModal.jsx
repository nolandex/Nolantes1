...
import '../styles/PaymentModal.css'; // File CSS untuk styling
      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="bg-blue-600 p-6 text-white">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-xl font-bold" id="modalPlan">
                {selectedPlan.name}
              </h2>
              <p className="text-blue-100 text-sm mt-1" id="modalProduct">
              ...
              <div className={`payment-details ${selectedMethod === 'virtual_account' ? 'active' : ''}`}>
                <div className="payment-details-content">
                  ...
                  <div className="method-grid mb-4">
                    <div
                      className="method-item bank-option"
                      data-bank="bca"
                      onClick={(e) => handleBankOptionClick('bca', e.target.closest('.payment-details'))}
                    >
                      <img
                    ...
                    <div
                      className="method-item bank-option"
                      data-bank="mandiri"
                      onClick={(e) => handleBankOptionClick('mandiri', e.target.closest('.payment-details'))}
                    >
                      <img
                    ...
                    <div
                      className="method-item bank-option"
                      data-bank="bni"
                      onClick={(e) => handleBankOptionClick('bni', e.target.closest('.payment-details'))}
                    >
                      <img
            ...
            <div className="payment-method-container">
              ...
              <div className={`payment-details ${selectedMethod === 'ewallet' ? 'active' : ''}`}>
                <div className="payment-details-content">
                  ...
                  <div className="method-grid mb-4">
                    <div
                      className="method-item payment-option"
                      data-wallet="dana"
                      onClick={(e) => handlePaymentOptionClick('dana', 'wallet', e.target.closest('.payment-details'))}
                    >
                      <img
                    ...
                    <div
                      className="method-item payment-option"
                      data-wallet="gopay"
                      onClick={(e) => handlePaymentOptionClick('gopay', 'wallet', e.target.closest('.payment-details'))}
                    >
                      <img
                    ...
                    <div
                      className="method-item payment-option"
                      data-wallet="ovo"
                      onClick={(e) => handlePaymentOptionClick('ovo', 'wallet', e.target.closest('.payment-details'))}
                    >
                      <img
                ...
                <div className="payment-details-content">
                  ...
                  <div className="method-grid mb-4">
                    <div
                      ...
                      onClick={(e) => handlePaymentOptionClick('alfamart', 'retail', e.target.closest('.payment-details'))}
                    >
                      <img
                    ...
                    <div
                      ...
                      onClick={(e) => handlePaymentOptionClick('indomaret', 'retail', e.target.closest('.payment-details'))}
                    >
                      <img
                        src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9f/Indomaret_logo.svg/1200px-Indomaret_logo.svg.png"
                        alt="Indomaret"
                        className="method-logo"
                      />
                    </div>
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg mb-4">
                    <div className="mb-3">
                      ...
                      <div className="flex items-center">
                        ...
                        <button
                          className Prioritas: 1
System: Saya akan melanjutkan tutorial lengkap untuk mengintegrasikan modal pembayaran ke dalam aplikasi React Anda, yang akan muncul saat tombol pada halaman pricing diklik. Tutorial ini akan melanjutkan dari kode `PaymentModal.jsx` yang telah dibuat sebelumnya dan mencakup langkah-langkah untuk membuat halaman pricing, mengatur styling, dan mengintegrasikan semuanya. Saya juga akan memastikan kode tetap sesuai dengan struktur proyek Anda (`Nolandexx/src/`) dan kebutuhan Anda.

### Tutorial Lengkap: Menambahkan Modal Pembayaran ke Tombol Pricing di React

#### Langkah 1: Membuat File CSS untuk Modal Pembayaran
Kita perlu menambahkan styling untuk `PaymentModal.jsx`. Styling ini diambil dari kode HTML sebelumnya dan akan ditempatkan di direktori `styles`.

**Buat file `PaymentModal.css` di `src/styles/`**:
